"""Optuna hyperparameter tuning for the MLP model (per-target, CV ensemble).

Usage::

    python -m dbp_prediction.cli.tune_mlp --trials 60
    python -m dbp_prediction.cli.tune_mlp --trials 120 --targets T_THMs_ug_L
"""
